...
import com.jayde.mybatis.util.WherePrams;

import java.io.Serializable;
import java.util.List;
import java.util.Map;

public interface DaoInterface<T extends Pojo, PK extends Serializable> {
     ...
     * @return 受影响的行数
     */
    public int updateLocal(T pojo, WherePrams where);
     ...
     * @return 受影响的行数
     */
    public int update(T pojo, WherePrams where);
