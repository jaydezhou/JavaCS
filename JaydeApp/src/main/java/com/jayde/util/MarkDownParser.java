 ...
 * @Author: jayde
 * @CreateDate: 2019-03-07 17:13
 * @UpdateUser: The Modified user
 * @UpdateDate: 2019-03-07 17:13
...
import com.jayde.util.markdownutil.mdtool.export.HTMLDecorator;
...
//        MarkDownParser md = new MarkDownParser("/Users/mac/IdeaProjects/JavaCS/JaydeApp/src/main/java/com/jayde/util/test.md");
//        md.createHtmlFile();
        File file = new File("/Users/mac/IdeaProjects/JavaCS/JaydeApp/src/main/java/com/jayde/util/test.md");
        String mdContent = "";
        try {
...
//        RootNode astRoot = pdp.parseMarkdown(mdContent.toCharArray());
//
//        System.out.println(astRoot.getAbbreviations());
//        System.out.println(astRoot.getReferences());
//        System.out.println(astRoot.getChildren());
//        List<Node> nodes = astRoot.getChildren();
//        for (Node node : nodes) {
//            log.info(node);
//            List<Node> nodes2 = node.getChildren();
//            for (Node node2 : nodes2) {
//                log.warn(node2.toString());
//                List<Node> nodes3 = node2.getChildren();
...
//        try {
//            log.info(markdown4jProcessor.process(file));
//        } catch (IOException e) {
//            e.printStackTrace();
//        }

        List<Block> list = Analyzer.analyze(mdContent);
...
//        System.out.println(MDTool.markdown2Html(mdContent));
    }
}