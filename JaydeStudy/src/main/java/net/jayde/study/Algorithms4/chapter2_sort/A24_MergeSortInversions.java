 ...
 *  @author Kevin Wayne
 */
public class A24_MergeSortInversions {

    // do not instantiate
    private A24_MergeSortInversions() { }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++)
            b[i] = a[i];
        StdOut.println(A24_MergeSortInversions.count(a));
        StdOut.println(A24_MergeSortInversions.count(b));
    }
}
