...
package net.jayde.study.Algorithms4.chapter3_find;

import net.jayde.study.Algorithms4.Queue;
 ...
 *  @author Kevin Wayne
 */
public class A31_SequentialSearchST<Key, Value> {
    ...
    public static void main(String[] args) {
        A31_SequentialSearchST<String, Integer> st = new A31_SequentialSearchST<String, Integer>();
